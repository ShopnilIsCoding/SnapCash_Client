...
const Registration = () => {
    ...
    return (
        <div className="min-h-screen bg-base-300 flex items-center justify-center text-white p-2">
            <div className="border border-black rounded-3xl p-2 lg:p-4 shadow-2xl">
