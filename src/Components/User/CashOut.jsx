...
const CashOut = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post('/cashOut', { amount:parseInt(amount), pin, agentMobileNumber,mobileNumber:user.mobileNumber });
      toast.success('Cash out successful');
      refetchUser();
      console.log(response.data);
    } catch (error) {
      toast.error(error.response?.data?.error || 'Cash out failed. Please try again.');
    }
